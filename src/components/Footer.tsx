import MovifyLogo from "../assets/logo.svg";
import MovifyLogoWhite from "../assets/logo-white.svg";
          ...
          <div className="row">
            ...
            <div className="col-lg-3 col-md-6 col-sm-12">
              <div className="widget widget-about">
                <img src={MovifyLogo} alt="logo" className="logo" />
                <img src={MovifyLogoWhite} alt="white logo" className="logo-white" />
